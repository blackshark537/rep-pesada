...
export class CostosProdPage {
  ...
  menu:{name: string; url: string; icon: string}[] = [
    ...
    {name: 'Costos del maíz', url: 'costos-maiz', icon: '/assets/icon/corn.png'},
    {name: 'Costos de la soya', url: 'costos-soya', icon: '/assets/icon/soyabean.png'},
    ...
    {name: 'Elemento de costo', url: 'elemento-costo', icon: '/assets/icon/invoice.png'}
  ];
